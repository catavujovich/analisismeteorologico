...
This outlines how to propose a change to analisismeteorologico. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("catavujovich/analisismeteorologico", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://catavujovich.github.io/analisismeteorologico/CODE_OF_CONDUCT.md).
